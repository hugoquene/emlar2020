...
<http://www.r-project.org>, where one can also find a wealth of
...
Perhpas surprisingly, R is several things at once:
...
further: users may create their own *classes* of data objects (e.g.
