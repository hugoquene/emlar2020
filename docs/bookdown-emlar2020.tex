...
\FunctionTok{require}\NormalTok{(hqmisc)}
\FunctionTok{data}\NormalTok{(talkers)}
\NormalTok{age.cat }\OtherTok{\textless{}{-}} \FunctionTok{cut}\NormalTok{( talkers}\SpecialCharTok{$}\NormalTok{age, }\AttributeTok{breaks=}\DecValTok{2}\NormalTok{ )}
\NormalTok{phraselength.cat }\OtherTok{\textless{}{-}} \FunctionTok{cut}\NormalTok{( talkers}\SpecialCharTok{$}\NormalTok{nsyl, }\AttributeTok{breaks=}\DecValTok{2}\NormalTok{ )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{x24}\SpecialCharTok{$}\NormalTok{cond }\OtherTok{\textless{}{-}} \FunctionTok{as.factor}\NormalTok{(x24}\SpecialCharTok{$}\NormalTok{cond)}
\FunctionTok{contrasts}\NormalTok{(x24}\SpecialCharTok{$}\NormalTok{cond) }\OtherTok{\textless{}{-}} \FunctionTok{contr.treatment}\NormalTok{( }\FunctionTok{c}\NormalTok{(}\StringTok{".A"}\NormalTok{,}\StringTok{".B"}\NormalTok{,}\StringTok{".C"}\NormalTok{), }\AttributeTok{base=}\DecValTok{2}\NormalTok{ )}
\end{Highlighting}
\end{Shaded}
